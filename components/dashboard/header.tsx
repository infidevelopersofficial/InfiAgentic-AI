    ...
    <header className="flex h-16 items-center justify-between border-b border-border bg-card px-6">
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          <Input placeholder="Search content, campaigns, leads..." className="w-80 pl-9" />
        </div>
      </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              ...
              <span className="text-xs text-muted-foreground">Blog post "AI Trends 2025" was approved</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              <span className="font-medium">Campaign completed</span>
              <span className="text-xs text-muted-foreground">Email campaign reached 50k subscribers</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1">
              <span className="font-medium">New lead captured</span>
              <span className="text-xs text-muted-foreground">John Doe from Acme Corp signed up</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
