...
function WorkflowsPage() {
    ...
    const handleCreateWorkflow = async (newWorkflow)=>{
        ...
        try {
            ...
            const duplicateName = workflows.some((workflow)=>workflow.name.toLowerCase() === newWorkflow.name.trim().toLowerCase());
            if (duplicateName) {
...
_s(WorkflowsPage, "bU+qeMt34oVTIWQUKJdSTy5MPNM=", false, function() {
    return [
...
//# sourceMappingURL=Codework_agentic-ai-platform_dd96b0a0._.js.map