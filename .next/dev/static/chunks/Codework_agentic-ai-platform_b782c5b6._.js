...
function CRMPage() {
    ...
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CRMPage.useMemo[metrics]": ()=>({
                ...
                avgScore: Math.round(leads.reduce({
                    "CRMPage.useMemo[metrics]": (acc, lead)=>acc + lead.score
                }["CRMPage.useMemo[metrics]"], 0) / leads.length)
            })
    }["CRMPage.useMemo[metrics]"], [
        leads
    ]);
        ...
        "CRMPage.useCallback[handleCreateLead]": async (newLead)=>{
            ...
            try {
                ...
                const duplicateEmail = leads.some({
                    "CRMPage.useCallback[handleCreateLead].duplicateEmail": (lead)=>lead.email === newLead.email
                }["CRMPage.useCallback[handleCreateLead].duplicateEmail"]);
                if (duplicateEmail) {
...
_s(CRMPage, "kEeZ6X9rNJ6O7ImkW9wzI0OhrE4=", false, function() {
    return [
...
//# sourceMappingURL=Codework_agentic-ai-platform_b782c5b6._.js.map