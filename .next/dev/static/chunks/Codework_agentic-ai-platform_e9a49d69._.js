...
function mapBackendApprovalToFrontend(backendApproval) {
    return {
        id: backendApproval.id,
        type: backendApproval.type,
...
function ApprovalsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ApprovalsPage.useEffect": ()=>{
            const fetchApprovals = {
                "ApprovalsPage.useEffect.fetchApprovals": async ()=>{
                    ...
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getApprovals(params);
            ...
            }["ApprovalsPage.useEffect.fetchApprovals"];
            fetchApprovals();
        }
    }["ApprovalsPage.useEffect"], [
        activeTab,
    ...
    const handleApprove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ApprovalsPage.useCallback[handleApprove]": async (request)=>{
            try {
                const updatedApproval = await __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].approveItem(request.id);
                const mappedApproval = mapBackendApprovalToFrontend(updatedApproval);
                setApprovals({
                    "ApprovalsPage.useCallback[handleApprove]": (prev)=>prev.map({
                            "ApprovalsPage.useCallback[handleApprove]": (approval)=>approval.id === request.id ? mappedApproval : approval
                        }["ApprovalsPage.useCallback[handleApprove]"])
                }["ApprovalsPage.useCallback[handleApprove]"]);
                toast({
    ...
    const confirmReject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ApprovalsPage.useCallback[confirmReject]": async ()=>{
            if (!selectedRequest) return;
            try {
                const updatedApproval = await __TURBOPACK__imported__module__$5b$project$5d2f$Codework$2f$agentic$2d$ai$2d$platform$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].rejectItem(selectedRequest.id, rejectComment);
                const mappedApproval = mapBackendApprovalToFrontend(updatedApproval);
                setApprovals({
                    "ApprovalsPage.useCallback[confirmReject]": (prev)=>prev.map({
                            "ApprovalsPage.useCallback[confirmReject]": (approval)=>approval.id === selectedRequest.id ? mappedApproval : approval
                        }["ApprovalsPage.useCallback[confirmReject]"])
                }["ApprovalsPage.useCallback[confirmReject]"]);
...
_s(ApprovalsPage, "Fkwv/u2+EBWk/n8rIenreclOXi4=", false, function() {
    return [
...
//# sourceMappingURL=Codework_agentic-ai-platform_e9a49d69._.js.map