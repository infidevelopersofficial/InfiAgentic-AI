...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('target_audience', postgresql.JSONB, default={}),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('org_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('organizations.id', ondelete='CASCADE'), nullable=False),
        sa.Column('account_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('social_accounts.id', ondelete='CASCADE'), nullable=False),
        sa.Column('content_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('content.id', ondelete='SET NULL')),
        sa.Column('platform', sa.String(50), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('plain_body', sa.Text),
        sa.Column('status', sa.String(20), default='draft'),
        sa.Column('audience_filter', postgresql.JSONB, default={}),
        sa.Column('scheduled_at', sa.DateTime(timezone=True)),
    ...
    op.create_table(
        ...
        sa.Column('email_sequence', postgresql.JSONB, default=[]),
        sa.Column('is_active', sa.Boolean, default=True),
    ...
    op.create_table(
        ...
        sa.Column('source_details', postgresql.JSONB, default={}),
    ...
    op.create_table(
        ...
        sa.Column('step_results', postgresql.JSONB, default=[]),
        sa.Column('error_message', sa.Text),
